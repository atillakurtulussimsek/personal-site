...
<head>
    ...
    <link rel="stylesheet" href="<?php echo CDN_URL; ?>/css/reset.css" type="text/css">
    <link rel="stylesheet" href="<?php echo CDN_URL; ?>/css/bootstrap-grid.min.css" type="text/css">
    <link rel="stylesheet" href="<?php echo CDN_URL; ?>/css/animations.css" type="text/css">
    <link rel="stylesheet" href="<?php echo CDN_URL; ?>/css/perfect-scrollbar.css" type="text/css">
    <link rel="stylesheet" href="<?php echo CDN_URL; ?>/css/owl.carousel.css" type="text/css">
    <link rel="stylesheet" href="<?php echo CDN_URL; ?>/css/magnific-popup.css" type="text/css">
    <link rel="stylesheet" href="<?php echo CDN_URL; ?>/css/main.css" type="text/css">

    <script src="js/modernizr.custom.js"></script>
  <script async src='<?php echo CDN_URL; ?>/cdn-cgi/bm/cv/669835187/api.js'></script></head>

  <body>
    <!-- Animated Background -->
    <div class="lm-animated-bg" style="background-image: url(<?php echo CDN_URL; ?>/img/main_bg.png);"></div>
    <!-- /Animated Background -->
          ...
          <header id="site_header" class="header mobile-menu-hide">
            <div class="header-content">
              <div class="header-photo">
                <img src="<?php echo CDN_URL; ?>/img/main_photo.jpg" alt="Alex Smith">
              </div>
                      ...
                      <div class="info-list">
                        <ul>
                          ...
                          <li>
                            ...
                            <span class="value"><a href="https://lmpixels.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="c2a7afa3abae82a7baa3afb2aea7eca1adaf">[email&#160;protected]</a></span>
                          </li>
                  ...
                  <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-4">
                      ...
                      <div class="lm-info-block gray-default">
                        ...
                        <h4>a<a href="https://lmpixels.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="670b021f27021f060a170b024904080a">[email&#160;protected]</a></h4>
                        <span class="lm-info-block-value"></span>
                        <span class="lm-info-block-text"></span>
                      </div>
                    ...
                    <div class="col-xs-12 col-sm-8">
                      ...
                      <form id="contact_form" class="contact-form" action="https://lmpixels.com/demo/breezycv/dark/3/contact_form/contact_form.php" method="post">
    ...
    <script data-cfasync="false" src="<?php echo CDN_URL; ?>/cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js"></script>
    <script src="<?php echo CDN_URL; ?>/js/jquery-2.1.3.min.js"></script>
    <script src="<?php echo CDN_URL; ?>/js/modernizr.custom.js"></script>
    <script src="<?php echo CDN_URL; ?>/js/animating.js"></script>

    <script src="<?php echo CDN_URL; ?>/js/imagesloaded.pkgd.min.js"></script>
    <script src='../../../../../www.google.com/recaptcha/api.js'></script>

    <script src='<?php echo CDN_URL; ?>/js/perfect-scrollbar.min.js'></script>
    <script src='<?php echo CDN_URL; ?>/js/jquery.shuffle.min.js'></script>
    <script src='<?php echo CDN_URL; ?>/js/masonry.pkgd.min.js'></script>
    <script src='<?php echo CDN_URL; ?>/js/owl.carousel.min.js'></script>
    <script src="<?php echo CDN_URL; ?>/js/jquery.magnific-popup.min.js"></script>

    <script src="<?php echo CDN_URL; ?>/js/validator.js"></script>
    <script src="<?php echo CDN_URL; ?>/js/main.js"></script>
  <script type="text/javascript">(function(){window['__CF$cv$params']={r:'660304da5bd6fd5e',m:'50228375aedc9e68502b8a3c47cb606a723fe8ea-1623835821-1800-Af/9sPH3GIwxruNpUsKCq+iXrqklQeXgYgNBqC8x8F5VI8WfxZ2PZ+NI09IUGidSENQXBgVEgHSZJwoijejGaLuAVTQgYdB+E/bNtM8+usWAeLWQW5tDamRu3naptgb4UCM0eCFGkRfmrq7ZvVK+dKNFcl8lj+PAnmn6CMGUAXdK',s:[0x54fccadd5b,0x3441057036],}})();</script><script defer src="../../../../../static.cloudflareinsights.com/beacon.min.js" data-cf-beacon='{"rayId":"660304da5bd6fd5e","version":"2021.5.2","r":1,"token":"94b99c0576dc45bf9d669fb5e9256829","si":10}'></script>
</body>
</html>